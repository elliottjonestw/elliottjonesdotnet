...
export const en: SiteContent = {
  person: {
    ...
    metaDescription:
      'Customer Success Manager at TXOne Networks. Over a decade in Taiwan and mainland China, with certified CEFR C1 Mandarin.',
    ogImageAlt:
  ...
  blog: {
    ...
    byAuthor: 'By ',
    minRead: 'min read',
    viewCountHeading: 'Article views',
    viewCount: '{count} views',
    viewCountDetailsOpen: 'View details',
    viewCountDetailsClose: 'Hide details',
    viewCountLast24Hours: 'Last 24 hours',
    viewCountLast30Days: 'Last 30 days',
    viewCountCountries: 'Top countries · 30 days',
    viewCountUpdated: 'Updated {date}',
