...
export const zhTW: SiteContent = {
  ...
  blog: {
    ...
    byAuthor: '作者：',
    minRead: '分鐘閱讀',
    viewCountHeading: '文章瀏覽次數',
    viewCount: '瀏覽 {count} 次',
    viewCountDetailsOpen: '展開詳情',
    ...
    commentsLocale: {
      ...
      email: '電子郵件（選填）',
      nickname: '暱稱',
      reply_placeholder: '留言',
      reply_btn: '回覆',
      sending: '傳送中…',
      mod_badge: '站長',
      content_is_required: '請填寫留言內容',
      nickname_is_required: '請填寫暱稱',
      comment_has_been_sent: '你的留言已送出，請等待審核。',
    },
    publishedOn: '發表於',
    newerPost: '較新的文章',
    olderPost: '較舊的文章',
